...
**Input**: `/specs/master/plan.md`, `/specs/master/data-model.md`, `/specs/master/contracts/`, `/specs/master/research.md`, `/specs/master/quickstart.md`
**Output**: `/specs/master/tasks.md` (this file)
...
- [ ] T011 [P] Create ChatHistory model in backend/src/models/chat.py
- [ ] T012 [P] Create PersonalizationSettings model in backend/src/models/personalization.py
- [ ] T013 [P] Create Chapter model in backend/src/models/content.py
- [ ] T014 [P] Create TranslationCache model in backend/src/models/content.py
- [ ] T015 [P] Create SubagentExecutionLog model in backend/src/models/content.py
- [ ] T020 [P] Set up database configuration in backend/src/core/database.py
- [ ] T021 [P] Set up security configuration in backend/src/core/security.py
- [ ] T022 [P] Set up application configuration in backend/src/core/config.py
- [ ] T025 [P] Create base API routes in backend/src/api/__init__.py
...
- [ ] T055 [P] [US2] Create RAG service in backend/src/services/rag_service.py
- [ ] T056 [P] [US2] Implement RAG API endpoints in backend/src/api/rag.py
- [ ] T057 [P] [US2] Add chat history storage in backend/src/services/chat_service.py
...
- [ ] T070 [P] [US3] Integrate better-auth.com in backend/src/api/auth.py
...
- [ ] T075 [P] [US3] Create personalization service in backend/src/services/personalization_service.py
- [ ] T076 [P] [US3] Implement personalization API endpoints in backend/src/api/personalization.py
...
- [ ] T090 [P] [US4] Create translation service in backend/src/services/translation_service.py
- [ ] T091 [P] [US4] Implement translation API endpoints in backend/src/api/translation.py
...
- [ ] T105 [P] [US5] Implement robotics content explanations subagent in skills/robotics_explanation_skill.py
- [ ] T106 [P] [US5] Implement ROS2 code generation subagent in skills/ros2_generation_skill.py
- [ ] T107 [P] [US5] Implement Urdu translation subagent in skills/translation_skill.py
- [ ] T108 [P] [US5] Implement personalized content suggestions subagent in skills/personalization_skill.py

### 7.2 Subagent Service Integration
- [ ] T110 [P] [US5] Create subagent service in backend/src/services/subagent_service.py
...
- [ ] T116 [P] [US5] Add subagent invocation endpoints in backend/src/api/subagents.py
